...
export const Bisseccion = () => {
  ...
  return (
    <Layout title="Hello">
      <center style={{fontSize:'30px',fontWeight:'bold'}}>Regula Falsi</center>
      <div
        style={{
          display: "flex",
        ...
        <Formik
          ...
          onSubmit={(values, { setSubmitting }) => {
            setTimeout(() => {
              axios
                .post(
                  "https://analisisapi.herokuapp.com/api/v1/methods/ReglaFake",
      ...
      <div className={style.wrapper}>
        <a href="../../blog/Methods01/regulafalsi">
